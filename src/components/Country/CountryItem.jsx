...
function CountryItem({ country }) {
  ...
  return (
    <div
      className="shadow bg-white-full dark:bg-darkBlue-el dark:text-white-bg rounded overflow-hidden cursor-pointer transition-shadow hover:shadow-xl md:hover:scale-105 "
      onClick={() => {
